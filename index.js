...
function showSelectedOperator(){
    ...
    for (var i=0; i<elements.length; i++){
        elements[i].style.backgroundColor  = "#007be6";
    }

    if (operator_value == "+"){
        document.getElementById("plusOp").style.backgroundColor  = "#007be6";
    }
    else if (operator_value == "-"){
        document.getElementById("subOp").style.backgroundColor  = "#007be6";
    }
    else if (operator_value == "*"){
        document.getElementById("multiOp").style.backgroundColor  = "#007be6";
    }
    else if (operator_value == "/"){
        document.getElementById("divOp").style.backgroundColor  = "#007be6";
    }
}
...
function keyPressed(e) {
    ...
    if (isNumber || operators.includes(e.key) || e.key == "Enter" || e.key == dotPress || 
        ...
        if (e.key == "Enter"){
            ...
            document.getElementById("backspace_btn").style.backgroundColor  = "#007be6";
            backspace_remove()
        }
        else if (commaPress){
            button_number(dot)
